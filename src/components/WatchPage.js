...
const WatchPage = () => {
  ...
  return (
    <div className={`flex-col w-full ${isMenuOpen ? 'blur-sm z-0 overflow-hidden h-screen' : ''}`} onClick={handleBlur}>
    <div className='px-10 flex w-full '>
      ...
      {!showLiveChat ? (
        <div className='h-4 px-auto text-center flex justify-center items-center mt-3 bg-gray-200 py-5 rounded-3xl cursor-pointer hover:bg-gray-300' onClick={handleShowLiveChat}>
